...
- [Linux环境使用 OHOS SDK 编译三方库](../tools/doc/ohos_use_sdk/OHOS_SDK-Usage.md)
- [OpenHarmony C/C++三方库移植适配指导说明](thirdparty_port.md)
  
### 在应用包（hap）中集成三方库

- :tw-1f195: [什么是OH的应用包(hap)](hap.md)
- :tw-1f195: [OH应用包编译构建分析](hap_build.md)
- :tw-1f195: [如何将三方库集成到hap包中](adapter_thirdlib_with_ide.md)
