...
- 三方库目录结构
  ...
  ```shell
  tpc_c_cplusplus/thirdparty/World-1.0.0   #三方库World-1.0.0的目录结构如下
  ├── docs                              #三方库相关文档的文件夹
  ├── HPKBUILD                          #构建脚本
  ├── HPKCHECK                          #测试脚本
  ├── SHA512SUM                         #三方库校验文件
  ...
  ├── README_zh.md                      #三方库简介
  ├── World-1.0.0_oh_pkg.patch          #用于World-1.0.0库编译的补丁
  ```
...
- 三方库头文件及生成的库
  ...
  ```shell
  World-1.0.0/arm64-v8a   World-1.0.0/armeabi-v7a
  ```
