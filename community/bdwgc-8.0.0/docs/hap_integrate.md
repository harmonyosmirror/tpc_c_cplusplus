...
- 三方库目录结构
  ...
  ```shell
  tpc_c_cplusplus/thirdparty/bdwgc-8.0.0   #三方库bdwgc-8.0.0的目录结构如下
  ├── docs                              #三方库相关文档的文件夹
  ├── HPKBUILD                          #构建脚本
  ├── HPKCHECK                          #测试脚本
  ├── SHA512SUM                         #三方库校验文件
...
- 三方库头文件及生成的库
  ...
  ```shell
  bdwgc-8.0.0/arm64-v8a   bdwgc-8.0.0/armeabi-v7a
  ```
...
```shell
  cd /data/tpc_c_cplusplus/thirdparty/bdwgc-8.0.0/bdwgc-8.0.0/arm64-v8a-build/
  ./ctest
```
