...
- 将jasper拷贝至tools/main目录下

  jasper编译依赖了`libjpeg-turbo`,因此编译时需要同时[编译`libjpeg-turbo`](../../libjpeg-turbo)

  ```shell
  cd tpc_c_cplusplus
  cp thirdparty/jasper tools/main -rf         ## 拷贝jasper三方库
  cp thirdparty/libjpeg-turbo tools/main -rf  ## 拷贝jasper依赖库libjpeg-turbo
  ```
...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ...
  ![jasper_usage](pic/jasper_usage.png)
