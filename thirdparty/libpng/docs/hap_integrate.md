...
- 三方库目录结构
  ```
  tpc_c_cplusplus/thirdparty/libpng  #三方库WavPack的目录结构如下
  ├── docs                              #三方库相关文档的文件夹
  ├── HPKBUILD                          #构建脚本
  ├── SHA512SUM                         #三方库校验文件
...
&nbsp;![thirdparty_install_dir](pic/libpng_install_dir.jpg)
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ...
  ```
  ![libpng_usage](pic/libpng_usage.jpg)
## 测试三方库
...
&nbsp;![libpng_test](pic/libpng_test.jpg)
