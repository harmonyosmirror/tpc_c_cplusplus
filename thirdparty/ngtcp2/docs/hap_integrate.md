...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ...
  ${CMAKE_CURRENT_SOURCE_DIR}/../../../libs/${OHOS_ARCH}/libnghttp3.so
  ${CMAKE_CURRENT_SOURCE_DIR}/../../../libs/${OHOS_ARCH}/libssl.so
  ${CMAKE_CURRENT_SOURCE_DIR}/../../../libs/${OHOS_ARCH}/libcrypto.so
  ${CMAKE_CURRENT_SOURCE_DIR}/../../../libs/${OHOS_ARCH}/libngtcp2_crypto_openssl.so
  ${CMAKE_CURRENT_SOURCE_DIR}/../../../libs/${OHOS_ARCH}/libngtcp2.so)
  #将三方库的头文件加入工程中
