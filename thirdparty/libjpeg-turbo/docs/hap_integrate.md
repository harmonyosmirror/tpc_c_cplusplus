...
- 将libjpeg-turbo拷贝至tools/main目录下
...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ...
  ![libjpeg-turbo_usage](../../thirdparty_template/pic/../docs/pic/xxx_usage.png)
...
&nbsp;![libjpeg-turbo_test](pic/jpeg_test.png)
