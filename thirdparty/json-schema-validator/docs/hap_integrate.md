...
- 将json-schema-validator拷贝至tools/main目录下
  ```
  cd tpc_c_cplusplus
  cp thirdparty/json-schema-validator tools/main -rf
...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ...
  ```
  ![json-schema-validator_usage](pic/json-schema-validator_usage.jpg)
## 测试三方库
