...
- 三方库头文件及生成的库
  ...
  ```
  WavPack/arm64-v8a   WavPack/armeabi-v7a
  ```
...
- 在最外层（cpp目录下）CMakeLists.txt中添加如下语句
  ```
  #将三方库加入工程中
  target_link_libraries(entry PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/WavPack/${OHOS_ARCH}/lib/libwavpack.a)   
  #将三方库的头文件加入工程中
  target_include_directories(entry PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/WavPack/${OHOS_ARCH}/include)
  ```
