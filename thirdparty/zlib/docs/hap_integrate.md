...
- 三方库目录结构
  ```
  tpc_c_cplusplus/thirdparty/zlib  #三方库zlib的目录结构如下
  ├── docs                          #三方库相关文档的文件夹
  ├── HPKBUILD                      #构建脚本
  ├── HPKBUILD                      #测试脚本
  ├── OAT.xml                       #OAT开源审查文本文件
...
# 将三方库的头文件加入工程中
target_include_directories(zlib PUBLIC ${CMAKE_CURRENT_SOURCE_DIR}/thirdparty/zlib/${OHOS_ARCH}/include)
```

  ![zlib_usage1](pic/zlib_usage.PNG)
