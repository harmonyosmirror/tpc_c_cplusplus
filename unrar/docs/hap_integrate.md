...
### 准备应用开发环境
开发环境的准备参考：[开发环境准备](https://gitee.com/zhong-luping/samples/blob/master/docs/napi%E7%B3%BB%E5%88%97%E5%AD%A6%E4%B9%A0/docs/hello_napi.md#%E5%B7%A5%E7%A8%8B%E5%87%86%E5%A4%87)
### 增加构建脚本及配置文件
- 下载本仓库，并解压
- 三方库目录结构
  ```
...
- 在工程顶级CMakeLists.txt中引入三方库，增加如下代码
  ...
  add_library(unrar SHARED unrar.cpp)  #工程依赖三方库unrar
  target_link_libraries(unrar PUBLIC libace_napi.z.so libhilog_ndk.z.so static_unrar)    #增加三方库头文件目录
  ```
